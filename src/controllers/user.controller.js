...
import {uoloadOnClousinary} from "../utils//cloudinary.js"
...
const registerUser = asyncHandler(async (req, res) => {
   ...
   const existedUser = User.findOne({
    ...
    const avatar = await uoloadOnClousinary(avatarLocalPath)
    const coverImage = await uoloadOnClousinary(coverImageLocalPath)
